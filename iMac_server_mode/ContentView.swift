...
//
/* I have an 2007 iMac installed Ubuntu 20.04. Now I want to build a smart TV with this iMac. My goal is after receiving electric source, the iMac  should act like server-mode mean it will automatically boot. This is the work instruction for my project:
 ...
 - Step 2: create a service call boot_on_power_apply.service
            ...
            + add these lines of commands into the service:
                    ...
                    # reboot register for 2007 iMac or Mac Mini with Intel ISA bridge
 ...
 - Step 3: shut down iMac and stop power source, then start power source again, and welcome to server mode on iMac!
